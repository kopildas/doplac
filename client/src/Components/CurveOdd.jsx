...
export default function CurveOdd({title}) {
  return (
   ...
   <div className=' bg-white absolute top-[3.12rem] left-32 w-14 h-[38px] border rounded-lg flex items-center justify-center text-blue-400 text-2xl z-20'>+
