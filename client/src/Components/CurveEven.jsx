...
export default function CurveEven({title}) {
  return (
    <div className='w-20 h-auto bg-green-00 flex flex-col items-center justify-center ml-[15rem]'>
             ...
             <div className=' bg-white absolute top-[3.12rem] left-5 w-14 h-[38px] border rounded-lg flex items-center justify-center text-blue-400 text-2xl z-20'>+
